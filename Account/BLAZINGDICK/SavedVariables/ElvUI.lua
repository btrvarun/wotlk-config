...
ElvDB = {
	["profileKeys"] = {
		...
		["Fatpotato - Icecrown"] = "Bowbaby - Icecrown",
	...
	["profiles"] = {
		["Invariably - Icecrown"] = {
			...
			["movers"] = {
				...
				["VehicleSeatMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-371,-325",
				...
				["ShiftAB"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,4,752",
